...
const defaultMembers: Member[] = [
  { id: 'Hacker-5233', username: 'ShadowRunner', phone: '+1-555-0123', email: 'shadow@hacker.net', progress: 87, verified: true, active: 'active', avatar: '/images/avatars/avatar-1.jpg', joinDate: '2024-01-15' },
  { id: 'Hacker-5234', username: 'NeonPhantom', phone: '+1-555-0124', email: 'neon@tech.org', progress: 64, verified: true, active: 'pending', avatar: '/images/avatars/avatar-2.jpg', joinDate: '2024-02-20' },
  { id: 'Hacker-5235', username: 'CyberWraith', phone: '+1-555-0125', email: 'wraith@dark.net', progress: 92, verified: false, active: 'active', avatar: '/images/avatars/avatar-3.jpg', joinDate: '2024-03-10' },
  { id: 'Hacker-5236', username: 'MatrixGhost', phone: '+1-555-0126', email: 'ghost@matrix.io', progress: 45, verified: true, active: 'failed', avatar: '/images/avatars/avatar-1.jpg', joinDate: '2024-01-28' },
  { id: 'Hacker-5237', username: 'CodeBreaker', phone: '+1-555-0127', email: 'breaker@code.dev', progress: 78, verified: true, active: 'active', avatar: '/images/avatars/avatar-2.jpg', joinDate: '2024-02-05' },
  { id: 'Hacker-5238', username: 'NullPointer', phone: '+1-555-0128', email: 'null@dev.tech', progress: 33, verified: false, active: 'pending', avatar: '/images/avatars/avatar-3.jpg', joinDate: '2024-03-22' },
]
